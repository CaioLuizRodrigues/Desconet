  ...
  return (
    <View style={{ flex:1 }} >
      ...
      <View style={{ flex:2 }} className="w-full bg-white flex justify-center items-center px-4 gap-6">
        ...
        <TouchableOpacity className="bg-blue-500  w-full rounded-xl px-4 flex items-center justify-center h-10">
        ...
        <Text className="color-blue-400" onPress={() => navigation.navigate("Register")}>Crie sua conta</Text>
        </Pressable>
      </View>
      </View>
  );
